    ...
    render() {
        return (
            <View style={localStyles.outer} >
                <ViroARSceneNavigator style={localStyles.arView} apiKey="YOUR API KEY"  ref={this._setARNavigatorRef}
    ...
    async _takeScreenshot() {
        try {
            const granted = await PermissionsAndroid.request(
                ...
                {
                    title: "Access external storage permission",
                    message:
                        "We need permission to external storage " +
            ...
            if (granted === PermissionsAndroid.RESULTS.GRANTED) {
                ...
                await this._arNavigator.sceneNavigator.takeScreenshot('ArImage', true)
